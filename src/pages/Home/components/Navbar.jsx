        ...
        <div className="">
            ...
            <nav className="navbar navbar-expand-lg navbar-light bg-dark p-3">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li className="nav-item active">
                            <a  className="nav-link text-white" >HAKKIMIZDA <span className="sr-only">(current)</span></a>
                        </li> <li className="nav-item active">
                            <a className="nav-link text-white" >PAKETLER <span className="sr-only">(current)</span></a>
                        </li>
                        <li className="nav-item active">
                            <a className="nav-link text-white" >EKİBİMİZ <span className="sr-only">(current)</span></a>
                        </li> <li className="nav-item active">
                            <a className="nav-link text-white" >İLETİŞİM <span className="sr-only">(current)</span></a>
                        </li>
                        <li className="nav-item active">
