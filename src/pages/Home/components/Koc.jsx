...
const [found, setFound] = useState(null)
    ...
    { url: "abdulkadir", name: "Abdulkadir Manisa", rankAndClass: "Sayısal 880: Hacettepe TIP (İngilizce)", ppUrl:require("./image/abdulkadirmanisa.jpeg"),contengane:"0", paragrapghe:
