...
const [found, setFound] = useState(null)
    ...
    const kocData = [
        ...
        { url: "mustafaerdemyildirim", name: "Mustafa Erdem Yıldırım", rankAndClass:  "Sayısal 23200: Kütahya sağlık bilimleri üniversitesi tıp fakültesi",fiyat:"700", ppUrl:require("./image/mustafaerdemyildirim.jpg"), contengane:"0", paragrapgheFirst:
        ...
        { url: "mervetoprakci", name: "Merve Toprakçı", rankAndClass: "Sayısal 6633: YTÜ Endüstri Mühendisliği",fiyat:"750", ppUrl:require("./image/mervetoprakci.jpeg"),contengane:"0", paragrapgheFirst:
        ...
        { url: "ibrahimegedogan", name: "İbrahim Ege Doğan", rankAndClass: "Sayısal 4267: KOÇ Elektrik Elektronik Mühendisliği",fiyat:"750", ppUrl:require("./image/ibrahimegedogan.jpeg"),contengane:"0", paragrapgheFirst:
      ...
      { url: "burakarikan", name: "Burak Arıkan", rankAndClass: "Eşit Ağırlık 65: KOÇ Ekonomi",fiyat:"800", ppUrl:require("./image/burakarikan.jpeg"),contengane:"0", paragrapgheFirst:
    ...
    { url: "abdulkadirmanisa", name: "Abdulkadir Manisa", rankAndClass: "Sayısal 880: Hacettepe TIP (İngilizce)",fiyat:"800", ppUrl:require("./image/abdulkadirmanisa.jpeg"),contengane:"0", paragrapgheFirst:
        ...
        { url: "kemalkayraergin", name: "Kemal Kayra Ergin", rankAndClass: "Sayısal 13203: İTÜ Fizik Mühendisliği",fiyat:"750", ppUrl:require("./image/kemalkayraergin.jpeg"),contengane:"0", paragrapgheFirst:
        ...
        { url: "ikraaksahin", name: "İkra Akşahin", rankAndClass: "Sayısal 13192: Pamukkale TIP",fiyat:"750", ppUrl:require("./image/ikraaksahin.jpeg"),contengane:"0", paragrapgheFirst:
       ...
       { url: "ahmetefeakbulut", name: "Ahmet Efe Akbulut", rankAndClass: "Sayısal 10274: Boğaziçi Fizik",fiyat:"750", ppUrl:require("./image/ahmetefeakbulut.jpeg"),contengane:"0", paragrapgheFirst:
      ...
      {found ?    <div className='koc'>
            ...
            <div className="koc-kart-right">
                <div className="koc-kart-right-top">
                    ...
                    <h2><span class="badge badge-warning">{found?.fiyat} ₺  </span></h2>
