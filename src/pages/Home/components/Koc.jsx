...
const [found, setFound] = useState(null)
    ...
    const kocData = [
        ...
        { url: "erdemyildirim", name: "Erdem Yıldırım", rankAndClass:  "Sayısal 23200: Kütahya sağlık bilimleri üniversitesi tıp fakültesi", ppUrl:require("./image/erdo.jpg"), contengane:"0", paragrapghe:
      ...
      { url: "burakarikan", name: "Burak Arıkan", rankAndClass: "Eşit Ağırlı 65: KOÇ Ekonomi", ppUrl:require("./image/burakarikan.jpeg"),contengane:"0", paragrapghe:
        "Merhaba ben Burak. YKS 2023'te eşit ağırlık alanında 65. oldum ve Koç Ekonomi bölümüne yerleştim. Lise hayatımın başlangıcında akademik olarak düzenli bir çalışma programına sahip olduğum söylenemez bu yüzden sürecin başlangıcında herkes gibi benim de stres yaptığım şeyler vardı ama sınava çalışmaya devam ettikçe kendime göre olan çalışma sistemini oturtup eksik olduğum yerleri kapatmayı başardım ve istediğim üniversiteye girebildim. Bu süreçte öğrendiğim bilgileri ve deneyimleri sizlerle paylaşıp sizin de kendinizi rahat hissettiğiniz bir çalışma sistemi oluşturmanıza ve hedefinize ulaşmanıza yardım etmek için buradayım. Önündeki engelleri aşmanda yardımcı olmayı çok isterim, umarım başarılarla dolu bir yıl geçirirsin."},
    { url: "abdulkadirmanisa", name: "Abdulkadir Manisa", rankAndClass: "Sayısal 880: Hacettepe TIP (İngilizce)", ppUrl:require("./image/abdulkadirmanisa.jpeg"),contengane:"0", paragrapghe:
        "Yks çalışmam gerektiğini 11. sınıfta anladım. Okul arkadaşlarıma göre düşük bir obp ile 11'de çalışmaya başladım. 12. sınıfta 4349 olan msü sıralamamı yaptığım büyük hatalarla yksde 11.119 tyt 14.418 yerleştirmeye çektim. Daha iyi yapabileceğime inandığım için tekrar denemek istedim. İkinci sene yksnin sadece çalışma olmadığını ayrıca psikolojik bir süreç olduğunu anladım, hatalarımı görüp daha farklı yollar denedim. İkinci sene 3850 msü sıralamasını süreci daha iyi yöneterek sayısal ham 689 yerleştirme 880 yaptım şu anda hacettepe tıpta (ing) okuyorum. Amacım sizlere bu 5 senede öğrendiklerimle yol göstermek. Hedeflerinize ulaşmanızda yardımım dokunursa ne mutlu bana."},
