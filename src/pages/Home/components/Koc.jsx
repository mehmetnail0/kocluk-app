...
const [found, setFound] = useState(null)
    ...
    const kocData = [
        ...
        { url: "mustafaerdemyildirim", name: "Mustafa Erdem Yıldırım", rankAndClass:  "Sayısal 23200: Kütahya sağlık bilimleri üniversitesi tıp fakültesi",oldPrice:"700",newPrice:"600", ppUrl:require("./image/mustafaerdemyildirim.jpg"), contengane:"0", paragrapgheFirst:
        ...
        { url: "mehmetnail", name: "Mehmet Nail Mutlu", rankAndClass: "Sayısal 21100: YTÜ Kontrol ve Otomasyon Mühendisliği",oldPrice:"700",newPrice:"600", ppUrl:"https://media.licdn.com/dms/image/C4D03AQEBJlgYXKNZQA/profile-displayphoto-shrink_800_800/0/1645980997002?e=2147483647&v=beta&t=8A5iqgsmCL0LFwrhT1vXaDGBTFon_eJHf8x6qyUVghk",contengane:"0", paragrapgheFirst:
        ...
        { url: "mervetoprakci", name: "Merve Toprakçı", rankAndClass: "Sayısal 6633: YTÜ Endüstri Mühendisliği",oldPrice:"750",newPrice:"650", ppUrl:require("./image/mervetoprakci.jpeg"),contengane:"0", paragrapgheFirst:
        "Merhaba, ben Merve Toprakçı. 2023 YKS'ye ilk kez girip sayısalda 6633. oldum. Bu sıralamayla YTÜ Endüstri Mühendisliği'ne yerleştim. Sınav senemde oldukça hata yaptım ve sonlara doğru bu hatalarımı düzelterek istediğim bantta bir sıralama yaptım. Başarının iyi bir plan ve programa ihtiyaç duyması ve bu yönde yaptığımız hataları geç fark etmemiz, potansiyelimizin altında bir sıralama yapmamıza neden olabilir. Biatalet Koçluk ekibinin bir parçası olarak, kendi hatalarımdan ve gözlemlerimden yola çıkarak size iyi bir yol gösterici olacağımdan mutluluk duyarım. Umarım başarıya birlikte emin adımlarla ulaşırız."},
        { url: "ibrahimegedogan", name: "İbrahim Ege Doğan", rankAndClass: "Sayısal 4267: KOÇ Elektrik Elektronik Mühendisliği",oldPrice:"750",newPrice:"650", ppUrl:require("./image/ibrahimegedogan.jpeg"),contengane:"0", paragrapgheFirst:
        "İbrahim Ege Doğan, Cemil Meriç Fen Lisesi'nde üniversiteyi 12. sınıfta kazandım. Formaliteleri hallettiğimize göre asıl meseleye gelebiliriz. Benden koçluk aldığınızda ne yapmanız konusunda herhangi bir derde girmeyeceğinizi ve sadece işinizle ilgilenebilme imkanınızın olacağını söyleyebilirim. Kendi sınav sürecimde kimseye koçluk veya rehberlik almadan kendi başıma çalışarak ilerlediğim için bir kişinin yapabileceği her hatayı yaptım. Sizi bu hatalara düşürmeyeceğim. Detaylar için ulaşabilirsiniz."},
      { url: "burakarikan", name: "Burak Arıkan", rankAndClass: "Eşit Ağırlık 65: KOÇ Ekonomi",oldPrice:"800",newPrice:"700", ppUrl:require("./image/burakarikan.jpeg"),contengane:"0", paragrapgheFirst:
    ...
    { url: "abdulkadirmanisa", name: "Abdulkadir Manisa", rankAndClass: "Sayısal 880: Hacettepe TIP (İngilizce)",oldPrice:"800",newPrice:"700", ppUrl:require("./image/abdulkadirmanisa.jpeg"),contengane:"0", paragrapgheFirst:
        ...
        { url: "kemalkayraergin", name: "Kemal Kayra Ergin", rankAndClass: "Sayısal 13203: İTÜ Fizik Mühendisliği",oldPrice:"750",newPrice:"650", ppUrl:require("./image/kemalkayraergin.jpeg"),contengane:"0", paragrapgheFirst:
        ...
        { url: "ikraaksahin", name: "İkra Akşahin", rankAndClass: "Sayısal 13192: Pamukkale TIP",oldPrice:"750",newPrice:"650", ppUrl:require("./image/ikraaksahin.jpeg"),contengane:"0", paragrapgheFirst:
    ...
    return (
      ...
      {found ?    <div className='koc'>
            ...
            <div className="koc-kart-left">
                ...
                <h7>
ilk 5 öğrenci için indirimli fiyat !
</h7>
            </div>
...
Ve diğer şahsi, çalışma noktasında karşılaştığınız problemlerinize çözümler bulabileceksiniz.
      ...
      Koçunuz, öğrenci tanıma formunu doldurduktan sonra 24 saat içinde size ulaşmak için iletişim bilgilerinizi kullanacaktır. Eğer süreçle ilgili bir sorun yaşıyorsanız, WhatsApp destek hattımızdan <a href="https://wa.me/905364901880">bize ulaşabilirsiniz</a>.
      </Accordion>
      <Accordion title="🧑‍🏫 Koçlukla ilgili">
    Seçtiğiniz koçların derecesine göre <b>aylık</b> ücretlendirme yapılmaktadır. Sunulan hizmetleri daha detaylıca sorup öğrenmek isterseniz <a href="https://wa.me/905364901880">buraya</a> tıklayabilirsiniz.
    <br/><br/>
• Haftalık Görüşme <br/><br/>
• Kişiye özel program <br/><br/>
• Net takibi istatistiği sistemi <br/><br/>
